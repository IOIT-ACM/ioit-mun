          ...
          <div className="row justify-content-between">
            <div className="col-lg-6 col-xl-4 mil-mb-10">
              ...
              <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                <Image
                  src={appData.footer.logo.image2}
                  alt="logo"
                  className="mil-mb-0 pt-2"
                  width={130}
                  height={110}
                />
                <Image
                  src={appData.footer.logo.image1}
                  alt="logo"
                  className="mil-mb-0"
                  width={140}
                  height={130}
            ...
            <div className="col-lg-12 col-xl-8">
              <div className="row justify-content-xl-end">
                ...
                <div className="col-lg-4 col-xl-4 mil-mb-30">
                  ...
                  {/* phone */}
                  <p
                    className="mil-light mil-text-xl mil-bold mil-mb-0"
                    style={{ fontSize: 17 }}
                  >
                    {appData.contacts.name}
                  </p>
