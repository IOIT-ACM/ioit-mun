          ...
          <div className="row justify-content-between align-items-center">
            <div className="col-lg-7">
              <div className="mil-hero-text">
                ...
                <h1 className="mil-h3 mil-mb-10" style={{ marginTop: '50px' }}>
                  {Data.title}
                </h1>
                ...
                <p className="">
                  ...
                  <br />I am delighted to welcome you to the Model United
                  Nations (MUN) platform. As Secretary-General, it is my honor
                  to address a community of passionate individuals dedicated to
                  diplomacy, global issues, and positive change. MUN empowers us
                  to simulate real-world diplomacy, fostering critical thinking,
                  negotiation, and collaboration. In this interconnected world,
                  your participation is more vital than ever. Together, we can
                  bridge divides, find innovative solutions, and inspire a
                  brighter future. Let us embrace the principles of the United
                  Nations, striving for peace, justice, and sustainable
                  development. I look forward to your invaluable contributions
                  and the impact we will create together.
                </p>
              </div>
            </div>
            <div className="col-lg-5">
              <div className="mil-hero-illustration">
                ...
                <Image
                  src={Data.image.url}
                  alt="Secretariat"
                  className="mil-photo-secretariat"
                  fill
                />
