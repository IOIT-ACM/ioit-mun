...
const SCROLL_STACK_CARD_CLASS = 'scroll-stack-card';
...
export const ScrollStackItem = ({ children, itemClassName = '', style = {} }) => (
  <div
    className={`${SCROLL_STACK_CARD_CLASS} ${itemClassName}`.trim()}
...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    calculateProgress, parsePercentage, getElementOffset
  ]);

  useEffect(() => {
    const cards = Array.from(
      document.querySelectorAll(`.${SCROLL_STACK_CARD_CLASS}`)
    );
  ...
  return (
    ...
    >
      <div style={{ position: 'relative', minHeight: '100vh', paddingBottom: '40vh' }}>
        {children}
